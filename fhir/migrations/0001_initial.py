    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, help_text='Link to Django User model', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fhir_patient', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_of', models.ForeignKey(blank=True, help_text='The organization of which this organization forms a part', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_organizations', to='fhir.fhirorganization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(help_text='Patient this observation is about', on_delete=django.db.models.deletion.CASCADE, related_name='observations', to='fhir.fhirpatient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(help_text='Patient who is taking the medication', on_delete=django.db.models.deletion.CASCADE, related_name='medication_statements', to='fhir.fhirpatient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(help_text='Patient involved in the encounter', on_delete=django.db.models.deletion.CASCADE, related_name='encounters', to='fhir.fhirpatient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(help_text='Patient who has the condition', on_delete=django.db.models.deletion.CASCADE, related_name='conditions', to='fhir.fhirpatient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(blank=True, help_text='Patient involved in the communication', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='communications', to='fhir.fhirpatient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, help_text='Link to Django User model', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fhir_practitioner', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'FHIR Practitioner',
                'verbose_name_plural': 'FHIR Practitioners',
                'indexes': [models.Index(fields=['name'], name='fhir_fhirpr_name_af9587_idx'), models.Index(fields=['active'], name='fhir_fhirpr_active_04da6c_idx')],
            },
        ),
        migrations.AddIndex(
