    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('results_json', django_cryptography.fields.encrypt(models.JSONField(blank=True, null=True))),
