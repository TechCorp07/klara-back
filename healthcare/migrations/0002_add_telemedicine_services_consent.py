# Generated by Django 4.2.7 on 2025-08-11 10:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='consent_type',
            field=models.CharField(choices=[('provider_access', 'Healthcare Provider Access'), ('research', 'Research Use'), ('caregiver_access', 'Caregiver Access'), ('data_sharing', 'Data Sharing with Third Parties'), ('medication_tracking', 'Medication Adherence Tracking'), ('vitals_monitoring', 'Vitals Monitoring'), ('wearable_integration', 'Wearable Device Integration'), ('telemedicine_services', 'Telemedicine Services')], max_length=25),
        ),
        migrations.CreateModel(
