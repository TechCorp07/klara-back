    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosed_date', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('resolved_date', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('icd10_code', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('is_primary', models.BooleanField(default=False)),
                ('diagnosing_provider', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('is_rare_condition', models.BooleanField(default=False)),
                ('biomarker_status', models.JSONField(blank=True, null=True)),
                ('genetic_information', healthcare.fields.EncryptedTextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('medical_record_number', healthcare.fields.EncryptedCharField(unique=True)),
                ('date_of_birth', healthcare.fields.EncryptedDateField()),
                ('gender', healthcare.fields.EncryptedCharField()),
                ('blood_type', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('height', healthcare.fields.EncryptedDecimalField(blank=True, null=True)),
                ('weight', healthcare.fields.EncryptedDecimalField(blank=True, null=True)),
                ('ethnicity', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('preferred_language', models.CharField(blank=True, max_length=50, null=True)),
                ('emergency_contact_name', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('emergency_contact_phone', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('emergency_contact_relationship', healthcare.fields.EncryptedCharField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('side_effects_notes', healthcare.fields.EncryptedTextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_name', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('device_id', healthcare.fields.EncryptedCharField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', healthcare.fields.EncryptedCharField()),
                ('unit', models.CharField(blank=True, max_length=50)),
                ('measured_at', models.DateTimeField()),
                ('source', models.CharField(blank=True, max_length=100)),
                ('source_device_id', models.CharField(blank=True, max_length=255)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('blood_pressure', healthcare.fields.EncryptedCharField(blank=True)),
                ('heart_rate', healthcare.fields.EncryptedIntegerField(blank=True, null=True)),
                ('temperature', healthcare.fields.EncryptedDecimalField(blank=True, null=True)),
                ('respiratory_rate', healthcare.fields.EncryptedIntegerField(blank=True, null=True)),
                ('oxygen_saturation', healthcare.fields.EncryptedIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', healthcare.fields.EncryptedDateField()),
                ('end_date', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('location', healthcare.fields.EncryptedCharField(blank=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('reason', healthcare.fields.EncryptedTextField(blank=True)),
                ('outcome', healthcare.fields.EncryptedTextField(blank=True)),
                ('complications', healthcare.fields.EncryptedTextField(blank=True)),
                ('follow_up_required', models.BooleanField(default=False)),
                ('follow_up_notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('for_rare_condition', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', healthcare.fields.EncryptedCharField()),
                ('description', healthcare.fields.EncryptedTextField(blank=True)),
                ('first_observed', healthcare.fields.EncryptedDateField()),
                ('last_observed', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ...
                ('impact_notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_date', healthcare.fields.EncryptedDateField()),
                ('completed_date', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('lab_location', healthcare.fields.EncryptedCharField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_name', healthcare.fields.EncryptedCharField()),
                ('value', healthcare.fields.EncryptedCharField()),
                ('unit', healthcare.fields.EncryptedCharField(blank=True)),
                ('reference_range', healthcare.fields.EncryptedCharField(blank=True)),
                ('is_abnormal', models.BooleanField(default=False)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('result_date', models.DateTimeField(auto_now_add=True)),
                ('interpretation', healthcare.fields.EncryptedTextField(blank=True)),
                ('biomarker_significance', healthcare.fields.EncryptedTextField(blank=True)),
                ('fhir_resource_id', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vaccine', healthcare.fields.EncryptedCharField()),
                ('date_administered', healthcare.fields.EncryptedDateField()),
                ('administered_by', healthcare.fields.EncryptedCharField(blank=True)),
                ('lot_number', healthcare.fields.EncryptedCharField(blank=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('manufacturer', healthcare.fields.EncryptedCharField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', healthcare.fields.EncryptedCharField()),
                ('diagnosed_age', healthcare.fields.EncryptedIntegerField(blank=True, null=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('is_deceased', models.BooleanField(default=False)),
                ('deceased_age', healthcare.fields.EncryptedIntegerField(blank=True, null=True)),
                ('deceased_reason', healthcare.fields.EncryptedCharField(blank=True)),
                ('is_rare_condition', models.BooleanField(default=False)),
                ('fhir_resource_id', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('pending', 'Pending'), ('failed', 'Failed'), ('inactive', 'Inactive')], default='pending', max_length=10)),
                ('external_id', healthcare.fields.EncryptedCharField(blank=True, null=True)),
                ('integration_details', models.JSONField(blank=True, null=True)),
                ('last_sync', models.DateTimeField(blank=True, null=True)),
                ('access_token', healthcare.fields.EncryptedTextField(blank=True, null=True)),
                ('refresh_token', healthcare.fields.EncryptedTextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('onset_date', healthcare.fields.EncryptedDateField()),
                ('resolved_date', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('symptoms', healthcare.fields.EncryptedTextField()),
                ('severity', models.IntegerField(help_text='Scale of 1-10')),
                ('hospitalized', models.BooleanField(default=False)),
                ('treatment', healthcare.fields.EncryptedTextField(blank=True)),
                ('notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agent', healthcare.fields.EncryptedCharField()),
                ('reaction', healthcare.fields.EncryptedTextField(blank=True)),
                ...
                ('last_occurrence', healthcare.fields.EncryptedDateField(blank=True, null=True)),
                ('treatment_notes', healthcare.fields.EncryptedTextField(blank=True)),
                ('fhir_resource_id', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
