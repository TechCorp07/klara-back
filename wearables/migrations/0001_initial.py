    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_user_id', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255, null=True))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(max_length=20)),
                ('measured_at', models.DateTimeField()),
                ('device_id', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255))),
                ('device_model', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255))),
                ('external_measurement_id', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255))),
